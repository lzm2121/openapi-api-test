...
desired_caps = {
  ...
  'deviceName': 'PQY0220A22063340', # 设备名，安卓手机可以随意填写
...
code = 'description("搜索查询").resourceId("tv.danmaku.bili:id/search_src_text")'
sbox = driver.find_element_by_android_uiautomator(code)
sbox.send_keys('白月黑羽')
# 输入回车键，确定搜索
...
code = 'className("android.widget.TextView").textContains("白月黑羽").instance(3)'
